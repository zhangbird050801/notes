经检验，如果直接复制粘贴另一个项目的，会出现诡异的 bug。

所以我们选择去官网 [uniapp官网](https://uniapp.dcloud.net.cn/tutorial/app-manifest.html)
在项目底下新建一个 `manifest.json` 文件:
```json
{
...
此时，在 HBuilder X 打开这个 json 文件会出现：
![](https://typora-birdy.oss-cn-guangzhou.aliyuncs.com/20250425092436461.png)

然后你就可以配置了。

如果没有识别成 uniapp 项目怎么办？
右键项目目录，选择重新识别项目类型。如果还不行，可能是项目缺少了什么文件之类。
![](https://typora-birdy.oss-cn-guangzhou.aliyuncs.com/20250425092545215.png)
