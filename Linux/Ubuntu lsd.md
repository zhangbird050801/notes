...
```shell
curl -L https://github.com/lsd-rs/lsd/releases/download/v1.1.5/lsd_1.1.5_amd64.deb -o ~/lsd.deb  
```
...
![|900](https://typora-birdy.oss-cn-guangzhou.aliyuncs.com/20250218211608309.png)

配置文件
```shell
vi ~/.config/lsd/config.yaml 
```
...
添加了显示头部：
![|650](https://typora-birdy.oss-cn-guangzhou.aliyuncs.com/20250218212054962.png)
